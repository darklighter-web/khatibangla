        ...
        <header class="sticky z-30 <?= $tc['topHeader'] ?> border-b px-4 lg:px-6 py-2.5" style="top:44px">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <button onclick="openPageGuide()" class="ml-2 w-6 h-6 rounded-full bg-blue-100 text-blue-600 hover:bg-blue-200 flex items-center justify-center text-xs font-bold transition flex-shrink-0" title="Page Guide">?</button>
                </div>
            </div>
        </header>
